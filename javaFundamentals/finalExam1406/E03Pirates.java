    ...
    public static void main(String[] args) {
     ...
     userInput = scanner.nextLine();
         ...
         while (!userInput.equals("End")){
             ...
             switch (commandName){
                 case "Plunder":
                     int peopleKill = Integer.parseInt(commandParts[2]);
                     ...
                     int remainingPeople = peopleBeforePlunder - peopleKill;
                     ...
                     if (remainingGold <= 0 || remainingPeople <= 0){
                         ...
                         if (remainingPeople <=0){
                             peopleKill = remainingPeople;
                         }
                         System.out.printf("%s plundered! %d gold stolen, %d citizens killed.%n",cityName,goldStolen,peopleKill);
                 ...
                 case "Prosper":
                     ...
                     System.out.printf("%d gold added to the city treasury. %s now has %d gold.",goldProsper,cityName,goldAfterProsper);
                    break;
             }
         }

        System.out.printf("Ahoy, Captain! There are %s wealthy settlements to go to:",cities.size());
         ...
         cities.entrySet().stream().sorted((left, right) -> {
             ...
             return  result;
         }).forEach(entry -> System.out.printf("%s -> Population: %d citizens, Gold: %d kg%n",entry.getKey(), entry.getValue()
